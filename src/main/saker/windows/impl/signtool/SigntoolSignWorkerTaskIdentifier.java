...
public class SigntoolSignWorkerTaskIdentifier implements TaskIdentifier, Externalizable {
	 ...
	 */
	public SigntoolSignWorkerTaskIdentifier() {
	}

	public SigntoolSignWorkerTaskIdentifier(SakerPath relativeOutput) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SigntoolSignWorkerTaskIdentifier other = (SigntoolSignWorkerTaskIdentifier) obj;
