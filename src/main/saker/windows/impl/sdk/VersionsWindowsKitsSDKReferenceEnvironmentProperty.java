...
public class VersionsWindowsKitsSDKReferenceEnvironmentProperty
	...
	public SDKReference getCurrentValue(SakerEnvironment environment) throws Exception {
		...
		sdkref = SakerWindowsImplUtils.searchWindowsKitsInProgramFiles(SakerWindowsImplUtils.PATH_PROGRAM_FILES_X86,
				versionpredicate);
		if (sdkref != null) {
			return sdkref;
		}
		sdkref = SakerWindowsImplUtils.searchWindowsKitsInProgramFiles(SakerWindowsImplUtils.PATH_PROGRAM_FILES,
				versionpredicate);
		if (sdkref != null) {
			return sdkref;
		}
